...
<div class="w-full lg:w-0/12 px-4 mx-auto mt-12">
  <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-100 border-0">
   ...
   <span style="
    font-size: 16px;
"><i>Create  Heavy Metal</i></span>
        </h6>
           <a href ="view-heavymetal" class="bg-pink-500 text-white active:bg-pink-600 font-bold  text-xs px-6 py-4 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 ease-linear transition-all duration-150" type="button">
       View Data
    </a>
      </div>
    </div>
...
" class="flex-auto px-4 lg:px-10 py-10 pt-0">
            <form method="post" action="{{ route('heavymetal.store') }}">
          @csrf
       <br>
      <div >
        ...
        <div class="flex flex-wrap">
          <div class="col-sm-4">
            <div class="relative w-full mb-3">
              ...
              <input name="heavymetal_id" type="text" 
              class="inputcolor border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded
               text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" disabled value="Auto Generated Id">
            </div>
          </div>
          <div class="col-sm-4">
           <div class="relative w-full mb-3">
        ...
        <div class="flex flex-wrap">
            ...
            <div class="col-sm-8 px-8">
              <div class="relative w-full mb-3">
               ...
               <textarea name="consignee_address" style="" class="consigneeaddress form-control inputcolor border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150">Address</textarea>
              </div>
            </div>
        ...
        <br>
          ...
          <div class="col-sm-12">
            <div class="relative w-full mb-3">
              ...
              value="WE HEREBY CERTIFY THAT OUR RICE IS WITHIN THE PARAMETERS OF HEAVY METAL AS UNDER:-">
            </div>
          </div>
  ...
  <td><button type="button" style="width: 42px;
    font-size: 10px;" class="btn btn-danger bdelete waves-effect waves-themed">x</button></td>
     ...
     <br> <table class="table.table-bordered" style="color:black; width:100%;" id="table-example">
		                        <thead>
		                            <tr>
    ...
    text-align: center; width:38px;" name="other_particular" class=" inputcolor border-0  placeholder-blueGray-300 
                  ...
                  text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" value="0.02">
</th>
        ...
        <div class="flex flex-wrap">
          <div class="w-full lg:w-12/12 px-4">
           ...
           Heavy Metal Note2
              ...
              rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" 
              value="THIS IS TO CONFIRMED THAT OUR RICE IS WITHIN THE PARAMETERS AS ABOVE.">
            </div>
          </div>
...
<br>
          ...
          <div class="col-sm-4 px-4">
            <div class="relative w-full mb-3">
             ...
             Closing Line-1
              ...
              rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" value="Thanking You">
            </div>
          </div>
          <div class="col-sm-4 px-4">
            <div class="relative w-full mb-3">
              ...
              <input type="text"  style="width:104%;" name="conventional" class="inputcolor border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm
               shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" value="Your Truly">
            </div>
          </div>
    ...
    display: flex;
    text-align: center;
    align-items: center;" type="submit" class="bg-purple-500 text-white active:bg-purple-600 font-bold  text-xs px-4 py-4 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 ease-linear transition-all duration-150"  >Save</button>
