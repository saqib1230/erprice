...
" class="panel-content">
    ...
    border-spacing: 0 15px;">
                  ...
                  text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150">
							...
							<a href="editheavymetal/{{ $gmdataa['id'] }}" class="btn btn-sm btn-primary btn-icon btn-inline-block mr-1" title="Edit"><i class="fal fa-edit"></i></a>
