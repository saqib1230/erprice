...
" class="flex-auto px-4 lg:px-10 py-10 pt-0">
            <form method="post" action="{{ route('heavymetal',$heavymetal->id) }}">
          @csrf
               @method('PUT')
       <br>
      <div >
        ...
        <div class="flex flex-wrap">
          ...
          <div class="col-sm-4">
           <div class="relative w-full mb-3">
              ...
              text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" value="{{$heavymetal->heavy_id }}">
            </div>
