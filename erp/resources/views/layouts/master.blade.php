...
<html lang="en">
    ...
    <body class="mod-bg-1 mod-nav-link ">
        ...
        <script>
            ...
            var classHolder = document.getElementsByTagName("BODY")[0],
                ...
                {},
                themeURL = themeSettings.themeURL || 'erp.cyberiandesign.com',
                themeOptions = themeSettings.themeOptions || 'erp.cyberiandesign.com';
            /** 
             * Load theme options
             **/
                        ...
                        <div class="settings-panel">
                            ...
                            <div class="expanded theme-colors pl-5 pr-3">
                                <ul class="m-0">
                                    ...
                                    <li>
                                        <a href="#" id="myapp-14" data-action="theme-update" data-themesave data-theme="{{asset('css/themes/cust-theme-14.css')}}">" data-toggle="tooltip" data-placement="top" title="Supernova" data-original-title="Supernova"></a>
                                    </li>
                                    <li>
                                        <a href="#" id="myapp-15" data-action="theme-update" data-themesave data-theme="{{asset('css/themes/cust-theme-15.css')}}">" data-toggle="tooltip" data-placement="top" title="Hoki" data-original-title="Hoki"></a>
                                    </li>
                                </ul>
                            </div>
                            <hr class="mb-0 mt-4">
 ...
 <script>
        ...
        <script src="{{asset('js/statistics/easypiechart/easypiechart.bundle.js')}}"></script<link rel="stylesheet" type="text/css" href="http://cdn.datatables.net/1.10.13/css/jquery.dataTables.css')}}">
<script type="text/javascript" charset="utf8" src="http://cdn.datatables.net/1.10.13/js/jquery.dataTables.js"></script>
	...
	NOTE: 	The file size is pretty big, but you can always use the
			build.js')}}on file to deselect any components you do not need under "export" -->  <script>
            /* defined datas */
