...
<!DOCTYPE html>
<!-- saved from url=(0061)https://tailwindcomponents.com/component/account-card/landing -->
...
<div class="w-full lg:w-0/12 px-4 mx-auto mt-12">
  <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-100 border-0">
   ...
   Debit Note For Contract Advance Form<br>
   <span style="
    font-size: 16px;
"><i>Create Contract</i></span>
        </h6>
        <a href ="/view-proforma" class="bg-pink-500 text-white active:bg-pink-600 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 ease-linear transition-all duration-150" type="button">
       View Data Debit Note Contract And<br> Advance
    </a>
      </div>
    </div>
...
@endif
   ...
   <form action="{{ route('proformaupdate',$Proforma->id) }}" method="POST">
        @csrf
        @method('PUT')
          ...
          <div class="col-sm-4 px-4">
            <div class="relative w-full mb-3">
              ...
              class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded
               text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" value="{{$Proforma->id}}">
            </div>
          </div>
          <div class="col-sm-4 px-4">
            <div class="relative w-full mb-3">
              ...
              <input type="text" name="pro_special_code" class="border-0 px-3 py-3 placeholder-blueGray-300 
              text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full
               ease-linear transition-all duration-150" value="{{$Proforma->pro_special_code}} ">
            </div>
          </div>
          <div class="col-sm-4 px-4">
            <div class="relative w-full mb-3">
              ...
              <input type="date" name="debitnote_date" data-date-format="YYYY MM DD"  class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 
              bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" value="{{$Proforma->debitnote_date}}">
            </div>
          </div>
          
        </div>

        <hr class="mt-12 border-b-1 border-blueGray-300"><br>
        <div class="flex flex-wrap">
          <div class="col-sm-4 px-4">
            <div class="relative w-full mb-3">
              <label class="block uppercase text-blueGray-600 text-xs font-bold mb-2" htmlfor="grid-password">
              ...
              <input type="text" name="contact" class="border-0 px-3 py-3 placeholder-blueGray-300 
              text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" value="{{$Proforma->contact}}">
            </div>
          </div>
          <div class="col-sm-4 px-4">
            <div class="relative w-full mb-3">
              ...
              <input type="text" name="buyer" class="border-0 px-3 py-3 placeholder-blueGray-300 
              text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" value="{{$Proforma->buyer}}">
            </div>
          </div>
          <div class="col-sm-4 px-4">
            <div class="relative w-full mb-3">
              ...
              <input type="text" name="buyer_address" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow 
              focus:outline-none focus:ring w-full ease-linear transition-all duration-150" value="{{$Proforma->buyer_address}}">
            </div>
          </div>
       ...
       <br>
        <div class="flex flex-wrap">
          <div class="col-sm-12 px-12">
            <div class="relative w-full mb-3">
              <label class="block uppercase text-blueGray-600 text-xs font-bold mb-2" htmlfor="grid-password">
                Subject Line
              </label>
              <input type="text" name="subject" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded
               text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" value="{{$Proforma->subject}}">
            </div>
          </div> </div>
...
<hr class="mt-12 border-b-1 border-blueGray-300"><br>
          <div class="col-sm-12 px-12">
            <div class="relative w-full mb-3">
              ...
              <input type="text" name="contact_ref_no" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600
               bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" value="{{$Proforma->contact_ref_no}}">
            </div>
          </div> 
...
<hr class="mt-12 border-b-1 border-blueGray-300"><br>
          <div class="col-sm-4 px-4">
            <div class="relative w-full mb-3">
              ...
              <input type="number" step="0.01" name="adv_amount" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow 
              focus:outline-none focus:ring w-full ease-linear transition-all duration-150" value="{{$Proforma->adv_amount}}">
            </div>
          </div>
          ...
          <div class="col-sm-4 px-4">
            <div class="relative w-full mb-3">
             ...
             Currency
              ...
              <input type="text" name="currency" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded
               text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" value="{{$Proforma->currency}}">
            </div>
          </div>
          <div class="col-sm-12 px-12">
            <div class="relative w-full mb-3">
              ...
              <input type="text" name="amount_in_word"  class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white 
              rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" value="{{$Proforma->amount_in_word}}">
            </div>
          </div>
          <div class="col-sm-12 px-12">
            <div class="relative w-full mb-3">
              ...
              <input type="text" name="note" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm
               shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" value="{{$Proforma->note}}">
            </div>
          </div>
...
<br>
        ...
        <div class="flex flex-wrap">
          <div class="w-full lg:w-12/12 px-4">
            ...
            <button style="float:right;" type="submit" class="btn btn-primary btn-lg active">Update</button>
        </div>
          </div>
        </div>
      </form>
