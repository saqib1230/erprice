...
<div class="row">
                            <div class="col-xl-12">
                                <div id="panel-1" class="panel">
                                    <div class="panel-hdr">
                                        <h2>
                                            GMO <span class="fw-300"><i>Entry!</i></span>
                                        </h2>
...
<div class="w-full lg:w-0/12 px-4 mx-auto mt-12">
  <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-100 border-0">
   ...
   GMO And Allergen Form<br>
   <span style="
    font-size: 16px;
"><i>Create GMO</i></span>
        </h6>
           <a href ="view-gmo" class="bg-pink-500 text-white active:bg-pink-600 font-bold  text-xs px-6 py-4 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 ease-linear transition-all duration-150" type="button">
       View Data
    </a>
      </div>
    </div>
...
" class="flex-auto px-4 lg:px-10 py-10 pt-0">
    <form method="post" action="{{ route('gmo.store') }}">
          @csrf
       <br>
        <div class="flex flex-wrap">
          <div class="col-sm-4 px-4">
            <div class="relative w-full mb-3">
              ...
              <input name="gmo_id" type="text" 
              class="inputcolor border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded
               text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" value="gmo_id ">
            </div>
          </div>
          <div class="col-sm-4 px-4">
            <div class="relative w-full mb-3">
              ...
              <input type="text" name="gmo_special_id" class="inputcolor border-0 px-3 py-3 placeholder-blueGray-300 
              text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full
               ease-linear transition-all duration-150" value="gmo_special_id ">
            </div>
          </div>
          <div class="col-sm-4 px-4">
            <div class="relative w-full mb-3">
              ...
              <input style="width:104%;" type="text" name="ref_no" class="inputcolor border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 
              bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" value="ref_no ">
            </div>
          </div>
        ...
        <div class="flex flex-wrap">
          <div class="col-sm-4 px-4">
            <div class="relative w-full mb-3">
              ...
              <input type="date" name="gmo_date" class="inputcolor border-0 px-3 py-3 placeholder-blueGray-300 
              text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" value="gmo_date ">
            </div>
          </div>
          <div class="col-sm-4 px-4">
            <div class="relative w-full mb-3">
              ...
              <input  type="text" name="consignee" class="inputcolor border-0 px-3 py-3 placeholder-blueGray-300 
              text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" value="consignee ">
            </div>
          </div>
          <div class="col-sm-4 px-4">
            <div class="relative w-full mb-3">
              ...
              <input style="width:104%;" type="text" name="consign_address" class="inputcolor border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow 
              focus:outline-none focus:ring w-full ease-linear transition-all duration-150" value="consign_address ">
            </div>
          </div>
        ...
        <div class="flex flex-wrap">
          <div class="col-sm-4 px-4">
            <div class="relative w-full mb-3">
              ...
              <input type="text" name="commodity" class="inputcolor border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded
               text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" value="commodity">
            </div>
          </div>
          <div class="col-sm-4 px-4">
            <div class="relative w-full mb-3">
              ...
              <input type="number" name="net_qty" class="inputcolor border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600
               bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" value="net_qty">
            </div>
          </div>
          <div class="col-sm-4 px-4">
            <div class="relative w-full mb-3">
              ...
              <input type="number" style="width:104%;"  name="gross_qty" class="inputcolor border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow 
              focus:outline-none focus:ring w-full ease-linear transition-all duration-150" value="gross_qty">
            </div>
          </div>
        ...
        <div class="flex flex-wrap">
          <div class="col-sm-4 px-4">
            <div class="relative w-full mb-3">
              ...
              <input type="number" name="no_bag" class="inputcolor border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded
               text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" value="no_bag">
            </div>
          </div>
          <div class="col-sm-4 px-4">
            <div class="relative w-full mb-3">
              ...
              <input type="text" name="port_loading" class="inputcolor border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white 
              rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" value="port_loading">
            </div>
          </div>
          <div class="col-sm-4 px-4">
            <div class="relative w-full mb-3">
              ...
              <input type="text"  style="width:104%;" name="port_discharge" class="inputcolor border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm
               shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" value="port_discharge">
            </div>
          </div>
        ...
        <div class="flex flex-wrap">
          <div class="w-full lg:w-12/12 px-4">
            <div class="relative w-full mb-3">
              ...
              <input type="text"  style="width:101%;" name="gmo_note" class="inputcolor border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white 
...
<br>
        ...
        <div class="flex flex-wrap">
          <div class="w-full lg:w-12/12 px-4">
            ...
            <button style=" width:9.5%; float:right; background:#886ab5;" type="submit" class="bg-purple-500 text-white active:bg-purple-600 font-bold  text-xs px-4 py-4 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 ease-linear transition-all duration-150"  >Save</button>
