          ...
          <div class="col-sm-4">
            <div class="relative w-full mb-3">
              <label class="block  text-blueGray-600 text-xs font-bold mb-2" htmlfor="grid-password">
                ...
                <select style="width:100%;" name="buyer_country" id="buyer_country" class="inputcolor border-0 px-3 py-3 placeholder-blueGray-300 
                ...
                <div class="flex flex-wrap">
                  ...
                  <div class="col-sm-4 ">
                    <div class="relative w-full mb-3">
                      <label class="block  text-blueGray-600 text-xs font-bold mb-2" htmlfor="grid-password">
                        ...
                        text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150">
                        <option value=""> Proforma Type</option>    
                  ...
                  text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" value="0" required>
                   ...
                   <div class="col-sm-4 nop">
                    <div class="relative w-full mb-3">
                      <label class="block  text-blueGray-600 text-xs font-bold mb-2" htmlfor="grid-password">
                        Starting Alphabetic Order
        
                      </label>
                         <select style="width:100%;" name="start_alpha" id="no_of_proforma" class="inputcolor border-0 px-3 py-3 placeholder-blueGray-300 
                        text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150">
...
">
    ...
    height: 65px;
    margin-top: 30px;" name="item_id[]" class="form-control border-0  rremove text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150">
    ...
    font-size: 10px;" class="btn btn-danger edelete">-</button></td>
                           ...
                           <tr class="eclone">
                            <br>
                             ...
                             class="text-center"></th>
                             <td style=" padding-top:5px; " colspan="2">
                               <input value="Advance Split For Proforma" type="text"style="font-weight: 700;" class="form-control inputcolor border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150">
                           ...
                           <tr class="eclone">
                             ...
                             class="text-center"></th>
                             <td style=" padding-top:5px; " colspan="2">
                               <input value="Advance Allocated To Proforma" type="text"style="font-weight: 700; " class="form-control inputcolor border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150">
...
">
                             ...
                             <th><button type="button" style="width: 42px;
    font-size: 10px;" class="tab_b btn btn-success fadd">+</button></th>
                           </tr>
                           <tr class="fclone">
                            <td>
          ...
          <select style="width: 250px;
    height: 65px;
    margin-top: 30px;" name="item_id_b[]" class="tab_b form-control border-0   fremove text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150">
                                <option value="">Select Item</option>    
                                <option value="1">Item A</option>
                                      <option value="2">Item B</option>
                                      <option value="3">Item C</option>
                             ...
                             <td>
                               ...
                               <input type="text" name="origin_b[]" style="width:100%;" class="tab_b form-control inputcolor border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150">
                             </td>
                             <td>
                                <input type="text" name="packing_b[]" style="width:100%;"  class="tab_b form-control inputcolor border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150">
            
                             </td>
                             <td>
                               <input type="text" name="quantity_b[]" style="width:100%;" class="tab_b calc_countb qtyb form-control inputcolor border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150">
            
                             </td>
                             <td>
                           <input type="text" name="unit_cost_b[]" style="width:100%;" class="tab_b calc_countb rateb form-control inputcolor border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150">
            
                             </td>
                             <td>
                               <input type="text" name="total_b[]" style="width:100%;"  readonly='readonly' class="tab_b amountb form-control inputcolor border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150">
                             ...
                             <td><button type="button" style="width: 42px;
    font-size: 10px;" class="tab_b btn btn-danger fdelete">-</button></td>
                           </tr>
...
var bc=$(this).val();
 //   alert(bc);
 if(bc==2){
 $(".tab_b").attr("disabled","disabled");
 }else{
 $(".tab_b").removeAttr("disabled","disabled");
 }
});
