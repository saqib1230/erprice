...
" class="panel-content">
                                            <!-- datatable start -->
                                          <table id="dt-basic-example" class="table  table-hover table-striped w-100" style="border-collapse: separate;
    border-spacing: 0 15px;">
                                                <thead class="bg-primary-600">
                                                    <tr>
                                                        <th>Id</th>
                                                        <th>Gmo Special Id</th>
                                                        <th>Date</th>
                                                        <th>Ref NO</th>
                  ...
                  text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150">
                                                      ...
                                                      <td class="tdspace">
                                                         ...
                                                         <td class="tdspace">
                                                            {{ $gmdataa['port_loading'] }}
                                                        </td>
                                                           
                                                      <td class="tdspace">
                                                            {{ $gmdataa['port_discharge'] }}
                                                        </td>     
							...
							<a href="editgmo/{{ $gmdataa['id'] }}" class="btn btn-sm btn-primary btn-icon btn-inline-block mr-1" title="Edit"><i class="fal fa-edit"></i></a>
          ...
          <div class="col-sm-4">
            <div class="relative w-full mb-3">
              <label class="block  text-blueGray-600 text-xs font-bold mb-2" htmlfor="grid-password">
                ...
                <select style="width:100%;" name="status" id="buyer_country" class="inputcolor border-0 px-3 py-3 placeholder-blueGray-300 
                text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150">
            ...
            <div class="relative w-full mb-3">
                <label class="block  text-blueGray-600 text-xs font-bold mb-2" htmlfor="grid-password">
                 SPS Liscene No
                  ...
                  <input type="text" name="lisc_no" class="inputcolor border-0 px-3 py-3 placeholder-blueGray-300 
            ...
            <div class="relative w-full mb-3">
              <label class="block  text-blueGray-600 text-xs font-bold mb-2" htmlfor="grid-password">
                Date
                  ...
                  <input type="date" name="lisc_no" class="inputcolor border-0 px-3 py-3 placeholder-blueGray-300 
                  text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" value="">
              </div>
          </div>
