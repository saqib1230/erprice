...
" class="panel-content">
  ...
  <label class="col-lg-2 control-label">Duration</label><br>
...
<br>
  ...
  <label class="col-lg-2 control-label">Custom</label>
   ...
   <input type="date" class="form-control" id="custom1" autocomplete="new-password"> -   <input type="date" class="form-control" id="custom2" autocomplete="new-password"> 
...
<br>
                                              ...
                                              <div class="col-lg-3">  <label class="form-label" >
                                                    Basic Multi Select
                                                </label>
                                                <select class="select2 form-control select2-hidden-accessible" multiple="" id="multiple-basic" data-select2-id="multiple-basic" tabindex="-1" aria-hidden="true">
                                               ...
                                               <div class="col-lg-3">  <label class="form-label" >
                                                ...
                                                <select class="inputsizepp inputcolor border-0 px-3 py-4 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150 odd form-control">
                                              ...
                                              <div class="col-lg-3">  <label class="form-label" >
                                                ...
                                                <select class="select2 form-control select2-hidden-accessible older-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150 odd form-control">
    ...
    background: #886ab5;
    height: 60px;" type="submit" class="bg-purple-500 text-white active:bg-purple-600 font-bold  text-xs px-4 py-4 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 ease-linear transition-all duration-150">Search</button>
                                            ...
                                            <!-- datatable start -->
                                          <table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100" style="border-collapse: separate;
    border-spacing: 0 15px;">
                                                <thead class="bg-primary-600">
                                                    <tr>
                                                        ...
                                                        <th>Age</th>
                                                        <th>Start date</th>
                                                        <th>Salary</th> <th>Salary</th> <th>Salary</th> <th>Salary</th> <th>Salary</th>
                                                        <th>Admin Console</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    ...
                                                    <tr class="inputsizepp inputcolor border-0 px-3 py-3 placeholder-blueGray-300 
                  text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150">
                                                        <td class="tdspace">Tiger Nixon</td>
                                                        <td class="tdspace">System Architect</td>
                                                        <td class="tdspace">Edinburgh</td>
                                                        <td class="tdspace">61</td>
                                                        <td class="tdspace">2011/04/25</td>
                                                        
                                                        <td class="tdspace">555,400</td>          <td class="tdspace">555,400</td>          <td class="tdspace">555,400</td>          <td class="tdspace">555,400</td>          <td class="tdspace">555,400</td>
                                                        <td class="tdspace"><div class="d-flex demo">
							<a href="javascript:void(0);" class="btn btn-sm btn-danger btn-icon btn-inline-block mr-1" title="Delete Record"><i class="fal fa-times"></i></a>
							<a href="javascript:void(0);" class="btn btn-sm btn-primary btn-icon btn-inline-block mr-1" title="Edit"><i class="fal fa-edit"></i></a>
							<div class="dropdown d-inline-block">
								<a href="#" class="btn btn-sm btn-primary btn-icon" data-toggle="dropdown" aria-expanded="true" title="More options"><i class="fal fa-plus"></i></a>
